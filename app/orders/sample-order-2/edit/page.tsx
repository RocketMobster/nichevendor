/**
 * @file orders/sample-order-2/edit/page.tsx
    ...
    <main className="flex min-h-screen flex-col p-4 md:p-6 pb-20">
      <header className="mb-6">
        <div className="flex items-center mb-4">
          <Link href="/orders/sample-order-2" className="text-gray-500 mr-2">
            ← Back
          </Link>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow p-6 mb-4">
        ...
        <div className="flex justify-between">
          ...
          <Link href="/orders/sample-order-2">
